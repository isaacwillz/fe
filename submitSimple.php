...
$proDownloadable = $_POST["proDownloadable"];
$proRegularPrice = $_POST["proRegularPrice"];
$proSalePrice = $_POST["proSalePrice"];
$proSalePriceDateFrom = $_POST["proSalePriceDateFrom"];
$proSalePriceDateTo = $_POST["proSalePriceDateTo"];
$proTaxStatus = $_POST["proTaxStatus"];
$proTaxClass = $_POST["proTaxClass"];
$proSku = $_POST["proSku"];
$proManageStock = $_POST["proManageStock"];
$proStockQuantity = $_POST["proStockQuantity"];
$proAllowBackorders = $_POST["proAllowBackorders"];
$proStockStatus = $_POST["proStockStatus"];
$proSoldIndividually = $_POST["proSoldIndividually"];
...
$downloadFiles = $_POST["downloadFiles"];
$siteUrl = $_POST["siteUrl"];
$proVisible = $_POST["proVisible"];
$proFeatured = $_POST["proFeatured"];
$proDownloadLimit = $_POST["proDownloadLimit"];
$proDownloadExpiry = $_POST["proDownloadExpiry"];
...
// insert post meta
$metaKeys = array("_visibility", "_stock_status", "_downloadable", "_virtual", "_tax_status", "_tax_class", "_purchase_note", "_featured",
			"_weight", "_length", "_width", "_height", "_sku", "_regular_price", "_sale_price", "_sale_price_dates_from", "_price", "pv_commission_rate",
			"_sale_price_dates_to", "_sold_individually", "_manage_stock", "_backorders", "_stock", "_download_limit", "_download_expiry");
...
if($downloadFiles != "#" && $downloadFiles){
	$downloadFiles = explode("@", $downloadFiles);
	$md5 = md5(uniqid(rand(), true));
	
	$downloadString = "a:".count($downloadFiles).":{";
	foreach($downloadFiles as $file){
		$files = explode("#", $file);
		
		$downloadString .= 's:32:"'.$md5.'";';
		$downloadString .= "a:4:{";
			$downloadString .= 's:2:"id";';
			$downloadString .= 's:32:"'.$md5.'";';
			$downloadString .= 's:4:"name";';
			$downloadString .= 's:'.strlen($files[0]).':"'.$files[0].'";';
			$downloadString .= 's:4:"file";';
			$downloadString .= 's:'.strlen($files[1]).':"'.$files[1].'";';
			$downloadString .= 's:13:"previous_hash";';
			$downloadString .= 's:32:"'.$md5.'";';
		$downloadString .= "}";
	}
