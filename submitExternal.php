...
$metaKeys = array("_visibility", "_stock_status", "_downloadable", "_virtual", "_tax_status", "_tax_class", "_purchase_note", "_featured",
			"_sku", "_regular_price", "_sale_price", "_sale_price_dates_from", "_price", "pv_commission_rate",
			"_sale_price_dates_to", "_sold_individually", "_manage_stock", "_backorders", "_product_url", "_button_text");
...
foreach($metaKeys as $metakey){
	...
	elseif($metakey == "_backorders")
		$value = "no";
	elseif($metakey == "_product_url")
		$value = $proUrl;
	elseif($metakey == "_button_text")
		$value = $buttonText;
